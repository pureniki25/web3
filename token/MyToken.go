...
func (_Token *TokenCaller) MINETH(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "MIN_ETH")
...
//
// Solidity: function MIN_ETH() view returns(uint256)
func (_Token *TokenSession) MINETH() (*big.Int, error) {
	return _Token.Contract.MINETH(&_Token.CallOpts)
}

// MINETH is a free data retrieval call binding the contract method 0xd586b74c.
//
// Solidity: function MIN_ETH() view returns(uint256)
func (_Token *TokenCallerSession) MINETH() (*big.Int, error) {
	return _Token.Contract.MINETH(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) RATE(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "RATE")
...
//
// Solidity: function RATE() view returns(uint256)
func (_Token *TokenSession) RATE() (*big.Int, error) {
	return _Token.Contract.RATE(&_Token.CallOpts)
}

// RATE is a free data retrieval call binding the contract method 0x664e9704.
//
// Solidity: function RATE() view returns(uint256)
func (_Token *TokenCallerSession) RATE() (*big.Int, error) {
	return _Token.Contract.RATE(&_Token.CallOpts)
}
...
func (_Token *TokenTransactor) Mint(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "mint")
}

// Mint is a paid mutator transaction binding the contract method 0x1249c58b.
//
// Solidity: function mint() payable returns()
func (_Token *TokenSession) Mint() (*types.Transaction, error) {
	return _Token.Contract.Mint(&_Token.TransactOpts)
}

// Mint is a paid mutator transaction binding the contract method 0x1249c58b.
//
// Solidity: function mint() payable returns()
func (_Token *TokenTransactorSession) Mint() (*types.Transaction, error) {
	return _Token.Contract.Mint(&_Token.TransactOpts)
}
...
func (_Token *TokenTransactor) WithdrawETH(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "withdrawETH")
}

// WithdrawETH is a paid mutator transaction binding the contract method 0xe086e5ec.
//
// Solidity: function withdrawETH() returns()
func (_Token *TokenSession) WithdrawETH() (*types.Transaction, error) {
	return _Token.Contract.WithdrawETH(&_Token.TransactOpts)
}

// WithdrawETH is a paid mutator transaction binding the contract method 0xe086e5ec.
//
// Solidity: function withdrawETH() returns()
func (_Token *TokenTransactorSession) WithdrawETH() (*types.Transaction, error) {
	return _Token.Contract.WithdrawETH(&_Token.TransactOpts)
}
